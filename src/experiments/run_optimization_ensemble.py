"""Profit-proportional soft-voting ensemble experiment.

Compares HGB, RandomForest, and LogisticRegression as an ensemble
whose weights are proportional to each model's standalone OOF profit.
"""
